...
# learn wisdom
start1 = time.time()
bb = pyfftw.zeros_aligned(
    (nn, x, y), dtype="float32", n=8
)  # numpy array storing the real-space data
bf = pyfftw.zeros_aligned(
    (nn, x, y // 2 + 1), dtype="complex64", n=8
)  # numpy array storing the Fourier-space data
