...
from models.shallow_unet.shallow_unet_original_imp.suns.Network.shallow_unet import (
    get_shallow_unet_more,
    get_shallow_unet_more_equal,
)
...
def suns_batch(
    ...
    if display:
        ...
        print(
            "Pre-Processing time: {:6f} s, {:6f} ms/frame".format(
    ...
    if display:
        ...
        print(
            "CNN Infrence time: {:6f} s, {:6f} ms/frame".format(
    ...
    if display:
        ...
        print(
            "Post-Processing time: {:6f} s, {:6f} ms/frame".format(
...
def suns_online(
    ...
    if useSF == True:
        ...
        (bb, bf, fft_object_b, fft_object_c) = plan_fft(
            frames_init, (rows1, cols1), prealloc
        )
    else:
    ...
    if display:
        ...
        print(
            "Initialization time: {:6f} s, {:6f} ms/frame".format(
    ...
    if display:
        ...
        print(
            "Online time: {:6f} s, {:6f} ms/frame".format(
