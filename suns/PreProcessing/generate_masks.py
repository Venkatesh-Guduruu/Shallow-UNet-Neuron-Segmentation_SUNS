...
def generate_masks(
    ...
    experiment = fissa.Experiment(
        [network_input], [rois.tolist()], folder_FISSA, ncores_preparation=1
    )
...
def generate_masks_from_traces(
    file_mask: str, list_thred_ratio: list, dir_save: str, Exp_ID: str
):
    """Generate temporal masks showing active neurons for each SNR frame in "network_input".
