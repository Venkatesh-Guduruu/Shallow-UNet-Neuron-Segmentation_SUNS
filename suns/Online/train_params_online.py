...
from models.shallow_unet.shallow_unet_original_imp.suns.Online.parameter_optimization_online import (
    parameter_optimization_online,
)


def parameter_optimization_pipeline_online(
    file_CNN,
    network_input,
    dims,
    frames_initf,
    ...
    list_Recall, list_Precision, list_F1 = parameter_optimization_online(
        pmaps,
        frames_initf,
        merge_every,
        Params_set,
...
def parameter_optimization_cross_validation_online(
    cross_validation,
    list_Exp_ID,
    frames_initf,
    merge_every,
        ...
        for CV in list_CV:
            ...
            if os.path.exists(mat_filename) and load_exist:
                ...
                (
                    ...
                    list_Precision,
                    list_F1,
                ) = parameter_optimization_pipeline_online(
                    file_CNN,
                    network_input,
                    (Lx, Ly),
                    frames_initf,
