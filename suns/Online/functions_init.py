...
def init_online(
    ...
    # PreProcessing
    network_input, med_frame3 = preprocess_complete(
        bb,
        dimspad,
        dimsnb,
        network_input,
    ...
    if useMP:
        ...
        segs_init = p.starmap(
            separate_neuron,
            [(frame, None, minArea, avgArea, useWT) for frame in pmaps_b],
            chunksize=1,
        )
    else:
        segs_init = [
            separate_neuron(frame, None, minArea, avgArea, useWT) for frame in pmaps_b
        ]
