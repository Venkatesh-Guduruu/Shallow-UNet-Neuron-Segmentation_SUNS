...
@jit(
    "void(f4[:,:],u1[:,:],f4)", nopython=True, parallel=True, cache=True, fastmath=True
)
...
@jit(
    "void(f4[:,:], f4[:], u4)", nopython=True, parallel=True, cache=True, fastmath=True
)
